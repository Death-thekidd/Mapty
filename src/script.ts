...
class App {
	...
	private _toggleElevationField(e: Event) {
		e.preventDefault();
	...
	private _newWorkout(e: Event) {
		...
		const allPositive = (...inputs: any[]) => inputs.every((inp) => inp > 0);
		e.preventDefault();
	...
	private _renderWorkoutMarker(workout: any) {
